...
from bot338.api.routers.database import (
    APIFeedbackRequest,
    APIFeedbackResponse,
...
from bot338.api.routers.retrieve import (
    APIRetrievalRequest,
...
class APIClient:
    ...
    def retrieve(
        self, query: str, top_k: int = 10, reranking: bool = False
    ) -> APIRetrievalResponse:
        """Retrieves nodes given query.
        ...
        """
        request = APIRetrievalRequest(query=query, top_k=top_k, reranking=reranking)
...
class AsyncAPIClient(APIClient):
    ...
    async def retrieve(self, query: str, top_k: int = 10) -> APIRetrievalResponse:
        """Retrieves nodes given query.
