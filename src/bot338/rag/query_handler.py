...
QUERY_INTENTS = {
    Labels.SEARCH_BILL.value: "쿼리가 국회에서 발의된 법안을 검색하는 것과 관련되어 있습니다. 사용자가 요청한 법안에 대한 세부 정보를 검색하고, 검색된 의안들의 핵심 내용을 설명해서 검색결과를 제공해준다. 핵심 내용에는 의안의 배경 및 중요성을 포함하고 만약 비슷한 의안들이라면 의안들의 비교해서 차이점 또한 설명해준다.",
    Labels.WRITE_ARTICLE.value: "쿼리가 특정 발의안에 대한 기사 작성 요청과 관련되어 있습니다. 발의안의 핵심 내용을 요약하고, 해당 법안의 배경이나 중요성을 설명하는 기사를 작성하십시오.",
